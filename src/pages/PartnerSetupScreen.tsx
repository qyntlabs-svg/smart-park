        ...
        {step === 4 && (
          ...
          >
            ...
            <MobileButton
              ...
              fullWidth
              onClick={() => {
                // Trigger a print dialog which the user can "save as PDF" for
                // the entire QR sheet — works on Android/iOS/desktop without
                // any additional deps.
                toast.success("Preparing QR codes for print/download…");
