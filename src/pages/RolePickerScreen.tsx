...
import { AnimatedPage, hoverLift, hoverCapable } from "@/shared/motion";
...
const RolePickerScreen = () => {
  ...
  return (
    <AnimatedPage className="min-h-[100dvh] w-full max-w-md mx-auto bg-background flex flex-col items-center justify-center px-6">
      <motion.div
