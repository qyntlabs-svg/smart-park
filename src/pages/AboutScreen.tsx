    ...
    <div className="min-h-[100dvh] w-full max-w-md mx-auto bg-background flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide pb-8">
        ...
        >
          ...
          <p className="mt-1 text-caption text-primary font-semibold">
        ...
        <div className="mx-4 p-5 bg-card border border-border rounded-2xl">
          ...
          <p className="text-caption text-muted-foreground leading-relaxed">
            Auto Doc is on a mission to eliminate the daily struggle of finding
            parking in Indian cities. We connect vehicle owners with verified
            parking spaces in real-time, making urban commuting stress-free and
            efficient.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Find parking near you instantly",
              },
              {
                icon: Shield,
                title: "Verified Spaces",
                desc: "KYC-verified parking partners",
              },
              {
                icon: Zap,
                title: "Quick Booking",
              ...
              },
              {
                ...
                desc: "Earn from your parking space",
              },
        ...
        <div className="mx-4 mt-5 p-5 bg-card border border-border rounded-2xl space-y-3">
          ...
          <div className="space-y-2 text-caption text-muted-foreground">
            ...
            <p>
              ...
              42, Anna Salai, Guindy, Chennai – 600032, Tamil Nadu, India
            </p>
            <p>
        ...
        <div className="flex flex-col items-center pt-8 pb-4">
          ...
          <p className="text-caption text-muted-foreground mt-1">
            © 2025–2026 Auto Doc Technologies Pvt. Ltd.
          </p>
        </div>
      </div>
    </div>
